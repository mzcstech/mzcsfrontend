...
>>>>>>> 76e06855beec8ee387896d619ba5a1b8c74363fc
    ...
    //流转记录查看
    jumpToOriginalProcessRecordslList = (id) => {
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="TableCell" align="center" padding="none"><Button size="small" style={linkStyle} variant="text" color="primary" onClick={() => { this.jumpToOriginalProcessRecordslList(n.originalId) }}>流转记录</Button></TableCell>
